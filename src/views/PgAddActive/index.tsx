...
class AddActive extends React.Component {
	...
	componentDidMount() {
		sessionStorage.setItem('defaultSelectedKeys', '1')
		this.chearch()
	}
	// 添加
	AddhandleCancel = () => {
	...
	UpDhandleOk = () => {
		...
		let params = { Title: UpDateTitle, Http: UpDateHttp, Author: UpDateAuthor, Imgsrc: UpDateImgsrc, key}
		updateActivelistFn(params)
		setTimeout(() => {
			this.chearch()
			this.setState({
				updataVisible: false,
